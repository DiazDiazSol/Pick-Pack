...
// Traigo la categoría seleccionada
$categoria = Categoria::get_x_id($categoria_id);

// Traigo los productos filtrados
$catalogo = Producto::productos_x_categoria($categoria_id);
?>

<article class="d-flex justify-content-center bg-productos">
    <div>
        <h1 class="titulo text-center mb-5 pt-3 mt-4">
            <?= $categoria ? $categoria->getNombre() : "Catálogo" ?>
        </h1>
